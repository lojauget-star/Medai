      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className={isAdmin ? "lg:col-span-7 space-y-4" : "lg:col-span-12 space-y-4"}>
          <div className="flex items-center justify-between px-2">
            ...
            {isAdmin && guidelines.length === 0 && !loading && (
              <button 
                  ...
                  <div key={idx} className="bg-white p-4 px-5 rounded-2xl border border-slate-105 flex items-center justify-between group hover:border-[#6B4EFF]/20 transition-colors">
                    ...
                    {isAdmin && (
                      <button 
                        ...
                        className="text-slate-300 hover:text-red-500 hover:bg-red-50 p-2 rounded-xl transition-all shrink-0 animate-in fade-in"
                      >
                        <Trash2 className="w-4 h-4" />
                      </button>
                    )}
