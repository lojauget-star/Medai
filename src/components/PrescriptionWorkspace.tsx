                      ...
                      {!tutorMessage ? (
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            ...
                            {tutorPhone && (
                              <a
                                href={`https://api.whatsapp.com/send?phone=55${tutorPhone.replace(/\D/g, "")}&text=${encodeURIComponent(tutorMessage)}`}
                                target="_blank"
                                rel="noreferrer"
                                className="flex items-center justify-center bg-emerald-500 hover:bg-emerald-600 text-white p-3.5 rounded-full shadow-md cursor-pointer transition-all active:scale-95 shrink-0"
